package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_7:String = "crash_time";
      ...
      public static const const_14:String = "client.init.swf.error";
      
      public static const const_20:int = 9;
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_7] = new Date().getTime().toString();
            _loc7_ = "";
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            reportCrash("Failed to finalize main swf preloading: " + error.message,const_20,error);
         }
      }
