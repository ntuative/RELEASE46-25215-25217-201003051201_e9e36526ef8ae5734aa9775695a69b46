package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_699:Number = 64;
      
      public static const const_930:Number = 32;
       
      
      private var var_73:Vector3d;
      
      private var var_418:Number = 1;
      
      private var var_416:Number = 1;
      
      private var _y:Vector3d;
      
      private var var_1558:Number = 1;
      ...
      private var var_1557:Number = 1;
      
      private var var_2342:Number = 500;
      
      private var var_1559:Number = 1;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_83 = new Vector3d();
         var_1068 = new Vector3d();
         var_1558 = 1;
         var_1559 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1557 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_416 != param1 * var_1557)
         {
            var_416 = param1 * var_1557;
            ++var_80;
         }
      }
      ...
      {
         if(var_418 != param1 * var_1558)
         {
            var_418 = param1 * var_1558;
            ++var_80;
         }
      }
      ...
      {
         if(var_417 != param1 * var_1559)
         {
            var_417 = param1 * var_1559;
            ++var_80;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1068.assign(_loc22_);
         }
         else
         {
            var_1068.assign(_loc17_);
         }
         ++var_80;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_417;
         _loc2_.z *= var_416;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1068);
         if(_loc3_ < var_2343 || _loc3_ > var_2342)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_417;
            _loc2_.z *= var_416;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1068);
         }
      ...
      {
         return new Vector3d(0 * var_418,0 * var_417,0 * var_416);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_418,0 * var_417,0 * var_416);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_83;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_418,param2.y * var_417,param2.z * var_416);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_418,param3.y * var_417,param3.z * var_416);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_418,param4.y * var_417,param4.z * var_416);
