   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               var_438 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         var_438 += param2.width * param2.height * 4;
      }
      ...
      public function compress() : void
      {
         ...
         if(memUsage > memLimit)
         {
            ...
            var_325.splice(_loc2_,0 - _loc2_);
            if(memUsage > memLimit)
            {
               var_325.sortOn("memUsage",Array.NUMERIC);
