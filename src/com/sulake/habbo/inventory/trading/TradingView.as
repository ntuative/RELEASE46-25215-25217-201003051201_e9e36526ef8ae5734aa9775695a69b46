package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_749:uint = 4284532064;
      
      private static const const_748:uint = 2577770;
      
      public static const const_931:int = 0;
      ...
      private var var_337:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_337 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_916)
            {
            ...
            var_337.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_394);
            var_337.show();
         }
      ...
      {
         var _loc2_:ITextWindow = var_62.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_62.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         return var_62.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      ...
      {
         var _loc2_:ITextWindow = var_62.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_62.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(var_62 == null)
         {
            var_62 = createNormalWindow();
         }
         if(var_1422 == null)
         {
            var_1422 = createMinimizedWindow();
         }
         if(!var_1764)
         {
            return var_62;
      ...
      {
         var _loc2_:ITextWindow = var_62.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc1_:ITextWindow = var_62.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_62.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc1_:ITextWindow = var_62.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_62.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            updateActionState();
            _loc2_ = var_62.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = var_22.otherUserName;
            }
            _loc1_ = var_62.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_749) : uint(const_748);
            }
            _loc3_ = var_62.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = var_62.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_749) : uint(const_748);
            }
            _loc3_ = var_62.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      {
         return var_62.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_62)
         {
            _loc1_ = var_62.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
