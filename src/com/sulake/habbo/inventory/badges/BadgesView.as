package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1059:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1059 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_1059.procedure = method_6;
         var_1060 = _view.findChildByName("active_items") as IItemGridWindow;
         var_1060.procedure = activeGridEventProc;
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_1060.getGridItemIndex(param1.window);
      ...
      private function updateListViews() : void
      {
         ...
         var_1059.removeGridItems();
         var_1060.removeGridItems();
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               var_1059.addGridItem(_loc2_.window);
               _loc2_.window.procedure = method_6;
            }
            _loc3_++;
         }
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            var_1060.addGridItem(_loc2_.window);
      ...
      private function method_6(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_1059.getGridItemIndex(param1.window);
