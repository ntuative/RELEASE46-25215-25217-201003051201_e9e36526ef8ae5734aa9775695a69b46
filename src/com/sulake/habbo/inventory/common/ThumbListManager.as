package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1084:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_610 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_610.width;
         var_95 = var_610.height;
         var_1085 = param5;
         var_915 = param6;
         var_240 = Math.floor(var_1085 / _thumbWidth);
         var_19 = new BitmapData(var_1085,var_915);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_19.height < var_915)
         {
            _loc12_ = new BitmapData(var_19.width,var_915);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_610.width,var_610.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_610.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_610,var_610.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1084 != null)
         {
            _loc1_ = var_1084.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_19 = new BitmapData(Math.max(var_240 * _thumbWidth,var_1085),Math.max(var_521 * var_95,var_915),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_240 && var_19.height < _loc3_.y * var_95)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_240 - 1),var_95);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_240 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_95),null,null,true);
         _loc4_ = new Rectangle(0,var_95,_thumbWidth * (var_240 - 1),0 - var_95);
