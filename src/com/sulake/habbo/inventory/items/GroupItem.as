package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2258:BitmapData;
      
      protected var var_925:Boolean;
      
      protected var var_2257:Boolean;
      
      protected var var_2238:int;
      ...
      private const const_1405:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_734)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1514));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1363);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1405;
               _loc1_.blend = const_1405;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1361 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2258;
               _loc5_.visible = true;
            }
            else
            {
