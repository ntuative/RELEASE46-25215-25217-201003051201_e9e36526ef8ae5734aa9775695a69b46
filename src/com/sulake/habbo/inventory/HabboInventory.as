package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_917:IRoomSession;
      ...
      private const const_1636:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_17 != null)
         {
            var_17.events.removeEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_368,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_100:
               var_917 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_368:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_662));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_46.getValue(InventoryCategory.const_69));
      }
      ...
      {
         var_157.clubPeriods = param1;
         var_157.clubDays = param2;
         var_157.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_174));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_890));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1636);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_312));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_228:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_916.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_916.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_228));
      }
      ...
      {
         return var_157.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_46.getValue(InventoryCategory.const_360) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1086 = new IncomingMessages(this);
      ...
      {
         return var_157.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_157.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_241));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_368,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_360,_loc3_);
         ...
         var_46.add(InventoryCategory.const_174,_loc10_);
