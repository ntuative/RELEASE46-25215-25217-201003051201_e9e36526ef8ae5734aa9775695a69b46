package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_458 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_458.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_458.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_458.addGridItemAt(param1,param2);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_48)
         {
            ...
            _model.toggleItemSelection(_category,var_458.getGridItemIndex(param1.window));
            var_336 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_27 && var_336 != null && var_336 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_85)
         {
            var_336 == null;
         }
         ...
         else if(param1.type == WindowMouseEvent.const_234)
         {
