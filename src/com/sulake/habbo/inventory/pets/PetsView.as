package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_290:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_458 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_555 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_555.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_290 != null)
         {
            var_290.setSelected(false);
         }
         var_290 = param1;
         if(var_290 != null)
         {
            var_290.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_290.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_555.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_458.removeGridItem(_loc2_.window);
         if(var_290 == _loc2_)
         {
            var_290 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_555.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_458.addGridItem(_loc2_.window);
            var_555.add(param1.id,_loc2_);
            if(var_290 == null)
            {
               selectFirst();
            }
