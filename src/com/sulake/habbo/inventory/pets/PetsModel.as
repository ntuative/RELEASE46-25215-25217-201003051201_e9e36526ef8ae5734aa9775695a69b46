package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_174 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1114 && param1.type == RoomEngineObjectEvent.const_191)
         {
            var_11.showView();
            var_1114 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1114 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_34,RoomObjectTypeEnum.const_300,_loc3_.figure);
            var_11.closeView();
            return;
         }
      ...
      {
         if(var_940.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
