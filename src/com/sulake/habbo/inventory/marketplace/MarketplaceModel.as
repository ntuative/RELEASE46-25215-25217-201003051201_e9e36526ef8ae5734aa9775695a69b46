package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_210 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_210.ref));
         releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_210 is FloorItem ? 1 : 2;
         var_1600 = _loc2_;
         var_1596 = var_210.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_210.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1376,var_1377);
         }
      }
      ...
      {
         if(param1 != var_1600 || param2 != var_1596)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1595);
      }
      ...
      {
         if(var_11 != null && false && var_210 != null)
         {
            var_11.furniModel.removeLockFrom(var_210.id);
            var_210 = null;
         }
      }
