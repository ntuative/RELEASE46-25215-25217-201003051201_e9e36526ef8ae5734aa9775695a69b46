package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_781:uint = 11;
      ...
      private var var_1313:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1313 = new LagWarningLogger();
         var_1312 = new Array(const_781);
         var _loc4_:int = 0;
         while(_loc4_ < const_781)
         {
            var_1312[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1374,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1254,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1292,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_656,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_865,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1370);
               break;
            case HabboCommunicationEvent.const_523:
               trackLoginStep(HabboLoginTrackingStep.const_1348,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_215:
               trackLoginStep(HabboLoginTrackingStep.const_215);
               break;
            case HabboCommunicationEvent.const_163:
            ...
            case HabboCommunicationEvent.const_214:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_214);
               if(var_235 != null)
               {
                  var_235.init();
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_175)
         {
            Component(var_175).events.addEventListener(HabboConfigurationEvent.const_167,onConfigurationLoaded);
            if(var_235 != null)
            {
               var_235.configuration = var_175;
            }
            if(var_234 != null)
            {
               var_234.configuration = var_175;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_465,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_865,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_656,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_523,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_163,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_214,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_737,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_440:
               var_1313.registerWarning(LagWarningLogger.const_832);
         }
      }
         ...
         if(!disposed)
         {
            ...
            if(var_176)
            {
               if(true)
               {
                  ...
                  Component(var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_333,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_440,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_175)
         {
            Component(var_175).events.removeEventListener(HabboConfigurationEvent.const_167,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_88);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_88,onLocalizationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_819);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_819,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1544;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1544);
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_440,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_176).events.addEventListener(HabboFriendListTrackingEvent.const_333,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         {
            _crashed = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_7,new Date().getTime().toString());
            if(var_175)
            {
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_88,onLocalizationLoaded);
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1373);
         }
         else if(param1.type == HabboHotelViewEvent.const_376)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1191);
         }
