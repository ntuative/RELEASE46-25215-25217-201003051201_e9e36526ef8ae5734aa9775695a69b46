package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1605:int = 1;
      ...
      private const const_1606:int = 2;
      
      private var var_783:AvatarVisualizationData = null;
      
      private const const_1047:int = 3;
      ...
      {
         var_783 = param1 as AvatarVisualizationData;
         createSprites(const_1047);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_395.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_651);
         ...
         var _loc14_:Number = _loc8_ - var_1155;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_317);
         if(_loc16_ > 0)
         {
         ...
         var _loc21_:Boolean = _isAnimating || var_456 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_456;
            ...
            if(var_604 != _loc7_)
            {
               for each(_loc49_ in var_395.getKeys())
               {
                  var_395.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_783.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_395.remove(_loc5_);
               var_395.add(_loc5_,_loc6_);
               var_604 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_325);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_272) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_272);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_623);
            _loc6_.appendAction(AvatarAction.const_621,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_468);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_471);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_316,AvatarAction.const_1379[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_836);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_862,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1016);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_874);
               _loc55_ = 5;
            ...
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_567);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_1014,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_998);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_829,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_404);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_371) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_512);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_454);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_833);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_589,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_843))
            {
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_783.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
      ...
      override public function dispose() : void
      {
         ...
         if(var_395 != null)
         {
            _loc1_ = var_395.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_395.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
