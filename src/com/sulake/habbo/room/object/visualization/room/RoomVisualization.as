package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1366:int = 13421772;
      
      private static const const_1035:int = 16777215;
      
      public static const const_1350:int = 10066329;
      
      private static const const_1038:int = 13421772;
      
      public static const const_1149:int = 16777215;
      
      private static const const_1400:int = 0;
      
      public static const const_1317:int = 16777215;
      
      private static const const_1036:int = 10066329;
      
      private static const const_1037:int = 10066329;
      
      public static const const_1276:int = 13421772;
      ...
      private var var_1668:int = 255;
      
      protected var _data:RoomVisualizationData = null;
      
      private var _assetLibrary:AssetLibrary = null;
      
      private var var_1250:String = null;
      
      private var var_1664:int = -1000;
      
      private var var_950:uint = 16777215;
      ...
      private var var_541:Rectangle = null;
      ...
      private var var_1673:String = null;
      
      private const const_1604:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_879);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_900);
         var _loc7_:int = 0;
         while(_loc7_ < var_77.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_133)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_178,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1149;
               }
               else
               {
                  _loc13_.color = const_1366;
               }
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_236,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_257)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1317;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1276;
               }
               else
               {
            ...
            if(_loc13_ != null)
            {
               ...
               while(_loc15_ < var_77.getPlaneMaskCount(_loc7_))
               {
                  ...
                  _loc19_ = var_77.method_5(_loc7_,_loc15_);
                  _loc13_.addRectangleMask(_loc16_,_loc17_,_loc18_,_loc19_);
                  _loc15_++;
               }
               var_102.push(_loc13_);
            }
            _loc7_++;
         }
         var_1670 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_102 != null)
         {
            ...
            {
               _loc2_ = var_102[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            _loc3_ = var_102[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_236 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_541 == null)
         {
            var_541 = super.boundingRectangle;
         }
         return new Rectangle(var_541.x,var_541.y,var_541.width,var_541.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var_376.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:int = 0;
         while(_loc4_ < var_102.length)
         {
            _loc3_ = var_102[_loc4_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_376.maskCount)
         {
            _loc6_ = var_376.getMaskType(_loc5_);
            _loc7_ = var_376.getMaskLocation(_loc5_);
            _loc8_ = var_376.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_102.length)
               {
                  _loc3_ = var_102[_loc9_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_236 || _loc3_.type == RoomPlane.const_176 && _loc8_ == RoomPlaneBitmapMaskData.const_225)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1396;
                        if(var_77.getPlaneType(_loc9_) == RoomPlaneData.const_133)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1316)
         {
            var_1316 = param1.updateId;
            var_541 = null;
            _loc9_ = param1.direction;
            if(_loc9_ != null && (_loc9_.x != var_1064 || _loc9_.y != var_1667 || _loc9_.z != var_1672 || param1.scale != var_1665))
            {
               var_1064 = _loc9_.x;
               var_1667 = _loc9_.y;
               var_1672 = _loc9_.z;
               var_1665 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_974);
            if(_loc10_ != var_1673)
            {
            ...
            {
               var_950 = _loc11_;
               var_1666 = var_950 & 255;
               var_1671 = var_950 >> 8 & 255;
               var_1668 = var_950 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1664 + const_1604 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1664 = _loc7_;
         if(var_161 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_502);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_663);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_691);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1669 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_901));
            var_161 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_375.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_375[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_176)
            {
               if(var_1669)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1666 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1671 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1668 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_102.length)
         {
            _loc5_ = var_102[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_178 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_236 && param2 != null)
               {
                  _loc5_.id = param2;
               }
