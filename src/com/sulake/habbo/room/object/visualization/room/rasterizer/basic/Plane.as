package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      public function createPlaneVisualization(param1:int, param2:int, param3:Number, param4:Number) : PlaneVisualization
      {
         ...
         var_410.add(String(param1),_loc5_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc5_;
      }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_719 = var_410.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_719 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_410 != null)
         {
            ...
            {
               _loc1_ = var_410.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
