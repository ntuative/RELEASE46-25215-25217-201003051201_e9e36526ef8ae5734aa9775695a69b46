package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1310:int = const_284;
      ...
      public static const const_190:int = 4;
      
      public static const const_579:int = 6;
      
      public static const const_253:int = const_101;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1548 == const_101)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_507);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_507,var_26.width,var_507);
         }
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_770,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_507,param6,param7);
                     return param1;
                  }
                  return var_26;
               }
