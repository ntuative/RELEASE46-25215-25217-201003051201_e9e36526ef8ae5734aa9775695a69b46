package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_783:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_980);
         if(_loc12_ > 0)
         {
            ...
            if(_loc17_ < AvatarAction.const_988)
            {
               ...
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_840);
               var_456 = const_1048;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_272);
         switch(_loc14_)
         {
         ...
         var _loc16_:Boolean = _isAnimating || var_456 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            increaseUpdateId();
            _loc18_ = getTimer();
            ...
            if(var_604 != _loc7_)
            {
               for each(_loc36_ in var_395.getKeys())
               {
                  var_395.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_325);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_272);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_623);
            _loc6_.appendAction(AvatarAction.const_621,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            _loc24_ = _loc4_.getString(RoomObjectVariableEnum.const_468);
            if(_loc24_ != null && _loc24_ != "")
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_471);
               _loc39_ = 3;
               _loc40_ = _loc8_ - _loc38_;
               if(_loc40_ < _loc39_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_316,_loc24_);
               }
            }
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_371) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1047;
            ...
            {
               _loc29_ = null;
               _loc29_ = var_783.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
      ...
      {
         var_783 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
