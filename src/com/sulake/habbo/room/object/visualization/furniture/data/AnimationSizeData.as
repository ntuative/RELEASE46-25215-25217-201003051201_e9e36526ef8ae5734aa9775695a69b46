package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      {
         var _loc7_:* = null;
         var _loc6_:AnimationData = var_407.getValue(param2) as AnimationData;
         if(_loc6_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc4_:AnimationData = var_407.getValue(param2) as AnimationData;
         if(_loc4_ != null)
         {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_407.length)
            {
               _loc2_ = var_407.getWithIndex(_loc1_) as AnimationData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
