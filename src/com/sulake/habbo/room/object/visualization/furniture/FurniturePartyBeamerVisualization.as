package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_743:int = 15;
      
      private static const const_1042:int = 2;
      
      private static const const_340:int = 2;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_958[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_960[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_958 = new Array();
         var_958.push(Math.random() * _loc2_ * 1.5);
         var_958.push(Math.random() * _loc2_ * 1.5);
         var_959 = new Array();
         var_959.push(1);
         var_959.push(-1);
         var_961 = new Array();
         var_961.push(const_1042);
         var_961.push(const_1043);
         var_960 = new Array();
         var_960.push(getRandomAmplitudeFactor());
         var_960.push(getRandomAmplitudeFactor());
      }
