   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2164)
         {
            if(!param1)
            {
               var_279.assign(var_596);
               var_278.assign(var_597);
            }
            else
            {
               var_279.assign(var_596);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_73 == null && var_790 != null || var_279 == null || var_278 == null || var_460 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1316)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1064 || _loc4_.y != var_1667 || _loc4_.z != var_1672 || param1.scale != var_1665))
            {
               var_1064 = _loc4_.x;
               var_1667 = _loc4_.y;
               var_1672 = _loc4_.z;
