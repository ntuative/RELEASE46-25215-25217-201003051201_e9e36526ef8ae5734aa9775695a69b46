         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_105,_loc3_,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(var_1279)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_86,_loc1_,_loc2_);
