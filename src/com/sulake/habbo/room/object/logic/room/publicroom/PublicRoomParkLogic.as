package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1114:String = "bus_oviopen_hidden";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1113:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_395,0,_loc4_,_loc5_);
                     break;
                  case const_1115:
                  case const_1114:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_461,0,_loc4_,_loc5_);
               }
         }
