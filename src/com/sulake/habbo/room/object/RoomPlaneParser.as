package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_996;
         }
         var _loc2_:RoomPlaneData = var_102[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.type;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         addPlane(RoomPlaneData.const_257,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_766);
         addPlane(RoomPlaneData.const_139,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_139,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_108) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_139,Vector3d.sum(param1,Vector3d.product(param3,-var_108 / param3.length)),Vector3d.product(param3,(param3.length + var_108) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_766 / param2.length);
      ...
      {
         if(param1 == null || var_101 == null || param1 == var_101)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > var_101.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = var_101[_loc3_] as Array;
      ...
      private function getTileHeightInternal(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = var_101[param2] as Array;
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = var_102[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
            ...
            if(_loc6_ != null && _loc7_ != null && _loc8_ != null)
            {
               ...
               if(getPlaneMaskCount(_loc2_) > 0)
               {
                  ...
                  while(_loc13_ < getPlaneMaskCount(_loc2_))
                  {
                     ...
                     _loc17_ = method_5(_loc2_,_loc13_);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(var_101);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         var_645 = getFloorHeight(var_101);
         if(!param1)
         {
            createWallPlanes();
         }
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < var_101.length)
         {
            _loc4_ = var_101[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            _loc4_ = var_101[param2] as Array;
            ...
            {
               if(param1 == var_327 || param1 == var_330)
               {
                  _loc5_ = false;
                  _loc6_ = var_329;
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_133,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_133,_loc13_,new Vector3d(0,0,-var_108),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_133,_loc13_,new Vector3d(0,0,-var_108),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_133,_loc13_,new Vector3d(0,0,-var_108),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_133,_loc13_,new Vector3d(0,0,-var_108),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
