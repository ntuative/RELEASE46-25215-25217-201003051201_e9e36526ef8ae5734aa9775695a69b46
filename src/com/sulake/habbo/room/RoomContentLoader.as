package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private var var_946:IEventDispatcher = null;
      
      private var var_1126:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_440 = [];
         var_442 = [];
         var_1657 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1656 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_370 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_30:
                     if(var_440.indexOf(_loc4_) == -1)
                     {
                        var_440.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_28:
                     if(var_442.indexOf(_loc4_) == -1)
                     {
                        var_442.push(_loc4_);
                     }
                     break;
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_308,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_117 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_164 != null && var_164.hasWorldType(const_274 + param1))
         {
            return var_164.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_441.add(_loc10_,_loc11_);
                              if(var_440.indexOf(_loc14_) < 0)
                              {
                                 var_440.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_442.indexOf(_loc14_) < 0)
                              {
                                 var_442.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_370 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_370.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_326 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_326.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_370.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_370.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_338,const_483,ROOM_CONTENT,const_742,const_740];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1657.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_166 && _loc5_ != RoomObjectLogicEnum.const_117)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_441.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_440.indexOf(param1) >= 0)
         {
            return const_338;
         }
         if(var_442.indexOf(param1) >= 0)
         {
            return const_483;
         }
      ...
      {
         if(var_536.getValue(param1) != null)
         {
            return var_536.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_371 != null)
         {
            _loc2_ = var_371.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1656.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1126.add(_loc5_,_loc8_);
               var_164 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_308,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_1655)
         {
            ...
            if(var_946 != null)
            {
               var_946.dispatchEvent(new Event(const_574));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_164 != null)
         {
            return var_164.getWorldHeightScale(const_274 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_946 = param1;
            var_1652 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1658 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1654 = param2.getKey("public.room.dynamic.download.url","");
            var_1653 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_33 = const_741;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_326.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_371 != null)
         {
            var_371.remove(param1);
            var_371.add(param1,param2);
         }
         if(var_372 != null)
         {
            var_372.remove(param2);
            var_372.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_166 && _loc5_ != RoomObjectVisualizationEnum.const_117)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_274 + param1) == RoomObjectCategoryEnum.const_61)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1126.getValue(param1) != null)
         {
            var_164 = var_1126.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_164 != null)
         {
            return var_164.getWorldScale(const_274 + param1);
         }
         return 32;
      }
