package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1111:Number = 90;
      
      private static const const_761:int = 50;
      
      private static const const_1072:Number = 25;
      
      private static const const_1071:int = 50;
      ...
      private var var_1017:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1017 = param2;
         var_571 = new Timer(const_1072);
         var_571.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_491.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_491.splice(_loc3_,1);
            var_492.splice(_loc3_,1);
         }
         var_492.push(param1.name);
         var_491.push(param2);
         param1.addEventListener(WindowEvent.const_445,windowEventListener);
         param1.addEventListener(WindowEvent.const_216,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_491[var_492.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1017.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_293.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_293.splice(var_293.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1017.getIconLoc(param1.iconId);
      ...
      {
         return var_492[var_491.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_293[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_572[_loc3_] = new Array();
            }
            if(var_572[_loc3_].indexOf(param1) < 0)
            {
               var_572[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_761 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_761 || param1.desktop.height - param1.y < const_1071;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_492[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_572[_loc3_].length)
                  {
                     repositionWindow(var_572[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      public function animateWindowIn(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array = null) : void
      {
         ...
         _toolbarSize = param5;
         param3.visible = true;
         if(!windowShouldAnimate(param3,param5,param1.method_2,param6))
         {
