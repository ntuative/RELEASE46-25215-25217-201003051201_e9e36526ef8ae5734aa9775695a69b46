package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_186 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_927,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_977 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_977)
         {
         ...
         var_1150 = _loc7_.toolbar.@margin_bottom;
         var_1415 = _loc7_.toolbar.@min_group_margin;
         var_1414 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_248,param1,param2,_window,var_245);
         createGroupsFromXmlList(_loc9_,var_547,param1,param2,var_186,var_245);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_121,var_450,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1415,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1150) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1415,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1150) / -1));
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_.method_2 = _loc7_.@window_margin;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_121,var_450);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_547.length)
         {
            _loc2_ = var_547[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_121,var_450);
         }
      }
