package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_992,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_389,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_646,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_797,onHideWindowEvent);
         var_33 = true;
