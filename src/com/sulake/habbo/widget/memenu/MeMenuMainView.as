package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_147[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_147[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_147)
         {
            _loc6_ = var_147[_loc3_];
      ...
      {
         var_147 = new Dictionary();
         var_147["rooms_icon"] = ["gohome_white","gohome_color"];
         var_147["dance_icon"] = ["dance_white","dance_color"];
         var_147["clothes_icon"] = ["clothes_white","clothes_color"];
         var_147["effects_icon"] = ["effects_white","effects_color"];
         var_147["badges_icon"] = ["badges_white","badges_color"];
         var_147["wave_icon"] = ["wave_white","wave_color"];
         var_147["hc_icon"] = ["_white","_color"];
         var_147["settings_icon"] = ["settings_white","settings_color"];
         var_147["credits_icon"] = ["credits_white","credits_color"];
         var_147["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1017));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_572);
               break;
            case "rooms":
            ...
            case "clothes":
               ...
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_538));
               _widget.hide();
               break;
            case "settings":
