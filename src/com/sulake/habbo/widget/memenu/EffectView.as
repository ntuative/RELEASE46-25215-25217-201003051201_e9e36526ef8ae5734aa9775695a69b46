   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_881 = _window.findChildByName("effect_hilite");
            var_881.visible = false;
         }
         var_882 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_880 = _window.findChildByName("loader_bar");
         if(var_880 != null)
         {
            var_424 = var_880.width;
            var_167.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_882 != null)
         {
            var_882.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_882.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
