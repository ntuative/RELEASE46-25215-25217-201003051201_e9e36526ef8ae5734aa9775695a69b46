package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1613:String = "level";
      ...
      private const const_1611:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1617:uint = 3355443;
      
      private var var_212:IBorderWindow;
      
      private const const_1615:int = 158;
      ...
      private const const_1612:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_212 != null)
         {
            var_103 = var_212.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_103 == null || var_212 == null || var_60 == null)
         {
            return;
         }
         var_60.width = var_60.scrollableRegion.width;
         var_60.visible = false;
         var_103.height = var_103.scrollableRegion.height;
         var_212.height = NaN;
         _window.width = Math.max(var_212.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1186.getValue(var_665) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1613,param1.level,param1.levelMax);
         ...
         updateStateElement(const_1611,param1.nutrition,param1.nutritionMax);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1615,const_1616,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1612);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1617);
