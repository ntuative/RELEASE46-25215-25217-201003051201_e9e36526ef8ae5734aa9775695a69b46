package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_414:IItemGridWindow;
      
      private var var_888:BitmapData;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_414.destroyGridItems();
         var_290 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1320) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_508.width;
            _loc3_.height = var_508.height;
            var_414.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_508.width,var_508.height,true,0);
               _loc4_.bitmap.copyPixels(var_508,var_508.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_888.width,var_888.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_723.width,var_723.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_723,var_723.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_414.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_414.numGridItems)
         {
            return;
         }
         select(var_414.getGridItemAt(param1) as IWindowContainer);
      }
