package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_85 && param1.type != WindowMouseEvent.const_446)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1472 * (var_1015 - var_674)) + var_674;
      }
   }
}
