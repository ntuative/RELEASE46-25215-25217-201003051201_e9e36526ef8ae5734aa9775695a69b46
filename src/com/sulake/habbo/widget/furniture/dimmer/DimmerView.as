package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_340:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1050,const_1049,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_340 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_340 != null)
         {
            var_340.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1000 = _loc2_.light;
         if(var_340 != null)
         {
            var_340.setValue(var_1000);
         }
         var_408 = colors.indexOf(_loc2_.color);
         if(var_473 != null)
         {
            var_473.setSelectedColorIndex(var_408);
         }
