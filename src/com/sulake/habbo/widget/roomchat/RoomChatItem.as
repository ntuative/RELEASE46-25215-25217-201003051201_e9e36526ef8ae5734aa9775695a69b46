package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_488:int = 6;
      
      private static const const_344:int = 10;
      
      private static const const_1107:Number = 18;
      
      private static const const_1418:Number = 10;
      
      private static const const_1417:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1055,var_1057,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1055,var_1057,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1302 = param1.chatType;
         var_1055 = param1.userId;
         var_874 = param1.userName;
         var_1057 = param1.userCategory;
         _message = param1.text;
         var_1300 = param1.userX;
         var_197 = param1.userImage;
         var_1056 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_85,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1302)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_97:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_243:
         ...
         if(var_197 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_197.height);
         }
         ...
         if(var_197 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_197.width;
               _loc28_.height = var_197.height;
               _loc28_.bitmap = new BitmapData(var_197.width,var_197.height,true,0);
               _loc28_.bitmap.copyPixels(var_197,var_197.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_409 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_197.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1056 != 0)
            {
               _loc30_ = uint(var_1056 >> 16 & 255);
               _loc31_ = uint(var_1056 >> 8 & 255);
               _loc32_ = uint(var_1056 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1302 == RoomWidgetChatUpdateEvent.const_243)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_874);
            }
            else if(var_1302 == RoomWidgetChatUpdateEvent.const_252)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_874);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_409;
            _loc20_.width = _loc20_.textWidth + const_488;
            _width += _loc20_.textWidth + const_488;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_344 + _loc20_.textWidth + const_488;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1055,var_1057,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1055,var_1057,_roomId,_roomCategory,param1);
      }
