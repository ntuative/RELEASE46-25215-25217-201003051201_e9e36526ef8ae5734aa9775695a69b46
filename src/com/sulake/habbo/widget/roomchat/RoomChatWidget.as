package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1109:int = 6000;
      
      private static const const_1110:int = 9;
      
      private static const const_780:int = 4000;
      
      private static const const_1111:int = 3;
      
      private static const const_94:int = 18;
      
      private static const const_1072:int = 25;
      ...
      private static const const_492:int = (const_493 + const_345) * const_94 + const_94;
       
      
      private var var_876:Number = 1;
      
      private var _disposed:Boolean = false;
      
      private var var_593:int = 18;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_233 = new Array();
         var_716 = new Point();
         var_156 = const_492 + const_277;
         super(param1,param2,param3);
         var_2122 = param5;
         var_38 = param1.createWindow("chat_container","",HabboWindowType.const_57,HabboWindowStyle.const_36,HabboWindowParam.const_39,new Rectangle(0,0,200,var_156 + RoomChatHistoryPulldown.const_71),null,0) as IWindowContainer;
         var_38.background = true;
         var_38.color = 33554431;
         var_38.tags.push("room_widget_chat");
         var_356 = param1.createWindow("chat_contentlist","",HabboWindowType.const_984,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,200,var_156),null,0) as IItemListWindow;
         var_38.addChild(var_356);
         var_140 = param1.createWindow("chat_active_content","",HabboWindowType.const_57,HabboWindowStyle.const_39,HabboWindowParam.const_67,new Rectangle(0,0,200,var_156),null,0) as IWindowContainer;
         var_356.addListItem(var_140);
         var_24 = new RoomChatHistoryViewer(this,param1,var_38,param2);
         var_2124 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_659,onChatMessage);
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_684,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         var_356.width = 0 - 0;
         var_356.height = var_156;
         var_140.width = 0 - 0;
         if(historyViewerActive())
         {
            var_140.height = getTotalContentHeight() + const_277;
         }
         else
         {
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_886)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_66.length > const_1112 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_717 = getTimer() + const_780;
         }
         else
         {
            if(false && false)
            {
               var_593 = getItemSpacing(_itemList["-1"],var_66[0]);
            }
            else
            {
               var_593 = const_94;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_716.x) * var_876;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1309 && !historyViewerActive())
         {
            resetArea();
            var_1309 = false;
         }
      ...
      {
         return "chat_" + var_2122.toString() + "_item_" + (var_2123++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_659,onChatMessage);
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_684,onRoomViewUpdate);
      }
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!historyViewerActive() ? 0 : Number(var_504);
            if(_loc2_ == -1)
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(_isAnimating)
         {
            _loc2_ = param1 / const_1072 * const_1111;
            if(_loc2_ + var_718 > var_593)
            {
               _loc2_ = var_593 - var_718;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1540 == 0)
            {
               var_1540 = param1.scale;
            }
            else
            {
               var_876 = param1.scale / var_1540;
            }
         }
         if(param1.positionDelta != null)
         {
            var_716.x += param1.positionDelta.x / var_876;
            var_716.y += param1.positionDelta.y / var_876;
         }
         if(param1.rect != null)
         {
            if(var_24 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_2124)
         {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(false)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(var_504,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = var_504;
               if(_loc1_.aboveLevels > const_493 + const_345 + 2)
               {
                  _loc1_.aboveLevels = const_493 + const_345 + 2;
               }
               var_504 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_156 = param1 - 0;
         var_38.height = var_156 + RoomChatHistoryPulldown.const_71;
         if(var_24 != null)
         {
            var_24.containerResized(var_38.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:int, param3:int, param4:int, param5:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_501,param1,param3,param4);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_345 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1109)
               {
