      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_48:
               var_1331 = true;
               break;
            case WindowMouseEvent.const_85:
            case WindowMouseEvent.const_446:
               var_1331 = false;
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               ...
               {
                  case "accept_button":
                     _widget.acceptRequest(var_1074);
                     break;
                  case "decline_button":
                     _widget.declineRequest(var_1074);
                     break;
                  case "close_button":
                     _widget.ignoreRequest(var_1074);
               }
         }
      }
