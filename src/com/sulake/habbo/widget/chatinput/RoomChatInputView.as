package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1084:int = 20;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1039 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2026 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2027 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_700 = new Timer(1000,1);
         var_700.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_842 = new Timer(5000,1);
         var_842.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window.addEventListener(WindowEvent.const_445,onWindowMoved);
         var_1259 = true;
         var_136 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2028 = _loc2_.width + const_488 + _loc6_.width + const_1084;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1085,_loc8_.width) + const_488);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1039 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_136 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_499);
