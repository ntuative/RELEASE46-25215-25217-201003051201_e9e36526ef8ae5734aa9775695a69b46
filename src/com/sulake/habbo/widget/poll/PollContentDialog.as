package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function method_7() : void
      {
         ...
         var question:Dictionary = var_728[var_1075] as Dictionary;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1075;
         if(var_1075 < var_728.length)
         {
            _loc1_ = var_728[var_1075] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_728.length);
                  _loc2_.text = _loc6_;
               }
