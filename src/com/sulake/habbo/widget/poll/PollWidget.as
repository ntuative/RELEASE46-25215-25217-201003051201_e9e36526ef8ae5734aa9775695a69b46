package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_120,showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_58,showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_111,showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_120,showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_58,showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_111,showPollContent);
      }
