package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private var var_598:IWindowContainer;
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_45)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_49.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_443));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_598 = var_49.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_598.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         var_49.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.MEMENU_ARROW,var_598));
      }
