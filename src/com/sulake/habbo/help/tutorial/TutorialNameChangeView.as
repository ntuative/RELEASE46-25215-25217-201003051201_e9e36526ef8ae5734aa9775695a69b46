package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1468:uint = 13232628;
      
      private static var var_1939:uint = 11129827;
      ...
      private var var_259:IBorderWindow;
      
      private var var_821:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_49.localization.registerParameter("help.tutorial.name.available","name",var_397);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_usecurrent":
                  var_397 = var_49.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_49.localization.registerParameter("help.tutorial.name.confirmation","name",var_397);
         }
         if(var_259 == null)
         {
            var_259 = var_49.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_259 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_259);
            var_259.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_259.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1581 || param1 == ChangeUserNameResultMessageEvent.var_1582)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_821 = new NameSuggestionListRenderer(var_49);
         var _loc6_:int = var_821.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1468;
