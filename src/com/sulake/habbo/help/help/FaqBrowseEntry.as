package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(true)
         {
            main.sendMessage(new GetFaqTextMessageComposer(var_210.questionId));
            return;
         }
         var _loc3_:FaqCategory = var_210.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = var_210.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = hackHTML(var_210.answerText);
         }
         if(_loc3_ != null)
         {
      ...
      private function getNextItem() : FaqItem
      {
         ...
         var _loc2_:FaqCategory = var_210.category;
         if(_loc2_ == null)
         {
            return null;
         }
