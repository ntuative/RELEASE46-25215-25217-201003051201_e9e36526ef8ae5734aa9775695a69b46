package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends SearchViewController implements IHelpViewController
   {
      ...
      private static const const_1060:int = 60;
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_browse":
               main.showUI(HabboHelpViewEnum.const_460);
               break;
            case "help_habboway":
            ...
            case "help_cfh":
               ...
               main.showUI(HabboHelpViewEnum.const_318);
               break;
            case "help_report_user":
               main.component.callForHelpData.reportedUserId = 0;
               main.showUI(HabboHelpViewEnum.const_681);
            case "item_bg":
      ...
      override public function render() : void
      {
         ...
         if(_loc1_ == null || _loc1_.getFrontPageUrgentCategory().getAgeSeconds() > const_1060)
         {
