package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1469,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1470,this._model.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1469 = IButtonWindow(find("top_tab"));
         var_1470 = IButtonWindow(find("obj_tab"));
         var_1941 = IWindowContainer(find("tile_grid"));
         var_1940 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1469,onTopTabButton);
         Util.setProcDirectly(var_1470,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1941;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1940;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_57,HabboWindowStyle.const_36,HabboWindowParam.const_67,new Rectangle(0,0,param1.width,66)));
