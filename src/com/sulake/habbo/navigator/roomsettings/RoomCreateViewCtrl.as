package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_801:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_471 = new Timer(100);
         var_471.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_63 = new Array();
         var_63.push(new RoomLayout(false,104,"a"));
         var_63.push(new RoomLayout(false,94,"b"));
         var_63.push(new RoomLayout(false,36,"c"));
         var_63.push(new RoomLayout(false,84,"d"));
         var_63.push(new RoomLayout(false,80,"e"));
         var_63.push(new RoomLayout(false,80,"f"));
         var_63.push(new RoomLayout(true,80,"g"));
         var_63.push(new RoomLayout(true,74,"h"));
         var_63.push(new RoomLayout(false,416,"i"));
         var_63.push(new RoomLayout(false,320,"j"));
         var_63.push(new RoomLayout(false,448,"k"));
         var_63.push(new RoomLayout(false,352,"l"));
         var_63.push(new RoomLayout(false,384,"m"));
         var_63.push(new RoomLayout(false,372,"n"));
         var_63.push(new RoomLayout(true,416,"o"));
         var_63.push(new RoomLayout(true,352,"p"));
         var_63.push(new RoomLayout(true,304,"q"));
         var_63.push(new RoomLayout(true,336,"r"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_48 = IItemListWindow(var_20.findChildByName("item_list"));
         ...
         var_997 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_997.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_63.length)
         {
            _loc6_ = var_63[_loc4_];
            if(isAllowed(_loc6_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_63[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
         ...
         var_1817 = _navigator.data.hcMember;
      }
      ...
      public function dispose() : void
      {
         if(var_471)
         {
            var_471.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_471.reset();
            var_471 = null;
         }
      }
      ...
      {
         var_997.goBackToInitialState();
         var_997.input.textBackgroundColor = 4294967295;
         var_801 = var_63[0];
         if(var_1817 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_36,HabboWindowParam.const_67,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_997.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_801.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1188 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1188 = true;
            _loc3_.y = 1;
