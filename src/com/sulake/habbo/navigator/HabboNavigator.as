package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_868:ISessionDataManager;
      
      private var var_867:RoomCreateViewCtrl;
      
      private var var_1854:RoomThumbnailRenderer;
      ...
      private var var_275:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_275 = new MainViewCtrl(this);
         var_588 = new RoomInfoViewCtrl(this);
         var_867 = new RoomCreateViewCtrl(this);
         var_1854 = new RoomThumbnailRenderer(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_275.startSearch(Tabs.const_213,Tabs.const_328,param1);
         var_275.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_184 != null)
         {
            var_184.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_868)
         {
            var_868.release(new IIDSessionDataManager());
            var_868 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_184 != null)
         {
            var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_868 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_275.startSearch(Tabs.const_266,Tabs.const_195);
         var_388.getTab(Tabs.const_266).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_275.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
