package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1455:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_213,Tabs.const_219,"-1",MainViewCtrl.const_560);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1455 == null)
         {
            ...
            var_1455 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1455.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
