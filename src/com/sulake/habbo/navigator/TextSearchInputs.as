package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:Boolean, param3:IWindowContainer)
      {
         ...
         _navigator = param1;
         var_2296 = param2;
         var_738 = new TextFieldManager(_navigator,ITextFieldWindow(param3.findChildByName("search_str")),25,searchRooms,_navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = var_738.getText();
         if(_loc1_ == "")
         {
            return;
         }
         _navigator.mainViewCtrl.startSearch(Tabs.const_213,Tabs.const_219,_loc1_);
      }
   }
}
