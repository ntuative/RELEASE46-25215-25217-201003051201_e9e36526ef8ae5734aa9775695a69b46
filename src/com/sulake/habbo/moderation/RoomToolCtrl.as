package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_704:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_49,WindowTracker.const_546,_data.flatId),var_52,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_704.isSelected);
         var_49.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1335,_loc2_,var_398.text,"",""));
         if(false)
         {
            var_49.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1042.isSelected,var_1041.isSelected,var_704.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1281);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1311);
      }
      ...
      public function populate() : void
      {
         ...
         var_704 = ICheckBoxWindow(var_52.findChildByName("kick_check"));
         var_1042 = ICheckBoxWindow(var_52.findChildByName("lock_check"));
         var_1041 = ICheckBoxWindow(var_52.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         var_49.connection.send(new GetModeratorRoomInfoMessageComposer(var_378));
