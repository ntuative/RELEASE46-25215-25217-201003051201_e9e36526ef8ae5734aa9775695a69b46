package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_48 = param3;
         var_1251 = param4;
         var_1493 = var_574.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1493 == null)
            {
               return;
            }
            _loc2_ = var_1493.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            {
               _loc3_.id = _loc5_.id;
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,method_8);
            }
