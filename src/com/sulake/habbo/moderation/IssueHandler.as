package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_396:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_396 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_1010 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_396.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_111.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1010.load(_loc4_,var_111.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_56,WindowTracker.const_968,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_396 = new UserInfoCtrl(_window,var_56,_loc3_.message);
            var_396.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
