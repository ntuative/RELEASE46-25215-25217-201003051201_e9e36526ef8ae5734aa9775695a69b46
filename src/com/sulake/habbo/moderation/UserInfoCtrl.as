package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_756:int = 3600;
      
      private static const const_759:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_759) + " mins ago";
         }
         if(param1 < 2 * const_758)
         {
            return Math.round(param1 / const_756) + " hours ago";
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_49,WindowTracker.const_866,_data.userId),_callerFrame,var_1004,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_812.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_49.getXmlWindow("user_info"));
            var_812.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new ModActionCtrl(var_49,_data.userId,_data.userName,var_1231),_callerFrame,var_1004,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new RoomVisitsCtrl(var_49,_data.userId),_callerFrame,var_1004,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new SendMsgsCtrl(var_49,_data.userId,_data.userName,var_1231),_callerFrame,var_1004,false,true);
      }
