package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1500:IIssueBrowserView;
      
      private const const_1630:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1628:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1501:IIssueBrowserView;
      
      private const const_1638:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1629:String = "my_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_348.view.width = var_229.container.width;
         var_348.view.height = var_229.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1629:
               if(var_1501 == null)
               {
                  var_1501 = new MyIssuesView(issueManager,this,var_229.container);
               }
               return var_1501;
            case const_1630:
               if(var_1500 == null)
               {
                  var_1500 = new OpenIssuesView(issueManager,this,var_229.container);
               }
               return var_1500;
            case const_1628:
               if(var_1499 == null)
               {
                  var_1499 = new PickedIssuesView(issueManager,this,var_229.container);
               }
               return var_1499;
            default:
               return null;
