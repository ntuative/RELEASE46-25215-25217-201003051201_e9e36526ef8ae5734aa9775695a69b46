package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_2201:ModeratorInitMessageParser;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_2199:WindowTracker;
      ...
      private var var_2202:ModerationMessageHandler;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         {
            _connection = param1;
            var_2202 = new ModerationMessageHandler(this);
         }
      }
