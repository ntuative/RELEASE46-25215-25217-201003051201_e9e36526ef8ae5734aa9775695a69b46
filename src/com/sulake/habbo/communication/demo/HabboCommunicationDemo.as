package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1592:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_97:IHabboConfigurationManager;
      
      private var var_1375:ILogger;
      ...
      private var var_437:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_933)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_163);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_307:
               _loc3_ = var_97.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_810:
               _loc3_ = var_97.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_846:
               _loc3_ = var_97.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_809:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1594)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_621 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_621);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1105,var_1593));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_437.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_437.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1592);
      ...
      {
         var_621 = var_97.getKey("sso.ticket",null);
         var_1105 = var_97.getKey("flash.client.url","");
         var_1593 = var_97.getKey("external.variables.txt","");
         if(var_163 == null)
         {
         ...
         if(var_621 != null)
         {
            var_69.mode = HabboConnectionType.const_417;
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_523);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1592 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_69.mode)
         {
            case HabboConnectionType.const_417:
               ...
               var_934 = _loc4_;
               var_163.loadBannerImage(_loc7_ + "?token=" + var_934,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1302:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1269:
               var_935 = generateRandomHexString(30);
               var_437 = new DiffieHellman(new BigInteger(var_97.getKey("connection.development.prime"),16),new BigInteger(var_97.getKey("connection.development.generator"),16));
               var_437.init(var_935);
               _loc8_ = var_437.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_934);
         ...
         var_437 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_935 = generateRandomHexString(30);
            var_437.init(var_935);
            _loc12_ = var_437.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(var_97).events.addEventListener(HabboConfigurationEvent.const_167,onConfigurationLoaded);
         }
      }
