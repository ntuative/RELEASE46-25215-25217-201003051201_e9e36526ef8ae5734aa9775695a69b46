package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_627:String = "InitConnection";
      ...
      private var var_354:HabboCommunicationDemo;
      ...
      {
         var_354.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_354.shockwaveClientUrl = var_113.shockwaveClientUrl;
         var_354.ssoTicket = var_113.ticket;
         var_113.removeEventListener(SSOTicket.const_290,onParsedTicketSuccess);
         var_113.removeEventListener(SSOTicket.const_258,onParsedTicketFailure);
         var_113 = null;
         dispatchEvent(new Event(const_627));
      }
      ...
      {
         var _loc1_:XmlAsset = (var_354 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_354.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_442,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_354.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_85,windowEventProcessor);
         }
         else
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_354.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_354.habboCommunication.habboWebLogin(name,password);
         var_113 = new SSOTicket(var_354.assets,_loc2_,_loc1_);
         var_113.addEventListener(SSOTicket.const_290,onParsedTicketSuccess);
         var_113.addEventListener(SSOTicket.const_258,onParsedTicketFailure);
      }
