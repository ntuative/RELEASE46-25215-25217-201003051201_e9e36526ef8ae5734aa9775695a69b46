package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1261:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_816:ICatalogViewer;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1364 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1364) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1261;
            _loc2_.init();
         }
         var_1261.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1261.dispatchEvent(param1);
      }
