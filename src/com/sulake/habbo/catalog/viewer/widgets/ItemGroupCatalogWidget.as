package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_567[var_1009] as Array;
      ...
      {
         var _loc2_:Offer = var_567[var_1009][var_1927];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_359 || _loc1_.pricingModel == Offer.const_382)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_76 || _loc3_.productType == ProductTypeEnum.const_75)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1008.indexOf(_loc5_) == -1)
                        {
                           var_1008.push(_loc5_);
                           var_567.push(new Array());
                        }
                        _loc6_ = var_1008.indexOf(_loc5_);
                        (var_567[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_567)
         {
            if(var_1927 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1927] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1009 = var_927.getGridItemIndex(param1.view);
