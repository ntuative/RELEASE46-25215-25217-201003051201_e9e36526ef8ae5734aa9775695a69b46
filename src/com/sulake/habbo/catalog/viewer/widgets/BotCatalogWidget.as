package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_290:IGridItem;
      
      protected var var_927:IItemGridWindow;
      
      protected var var_1365:XML;
      
      private var var_1570:Map;
      
      private var var_897:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_927 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      private function populateGridItems() : void
      {
         ...
         var_1365 = _loc1_.content as XML;
         var _loc2_:int = 0;
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1365) as IWindowContainer;
         var_927.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = var_1570.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_98);
      ...
      {
         var _loc1_:String = var_1570.getValue(var_897.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_897,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_897.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_897.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_897.localizationId);
