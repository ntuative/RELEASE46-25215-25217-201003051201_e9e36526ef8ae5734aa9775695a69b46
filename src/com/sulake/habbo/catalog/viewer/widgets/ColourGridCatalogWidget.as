   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         for each(_loc1_ in var_1333)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_691.width,var_691.height,true,0);
               _loc3_.bitmap.copyPixels(var_691,var_691.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_840.width,var_840.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_692.width,var_692.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_692,var_692.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_692 = _loc4_.content as BitmapData;
         populateColourGrid();
