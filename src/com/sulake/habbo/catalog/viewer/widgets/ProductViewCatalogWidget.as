package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1444:Point;
      
      private var var_1819:Array;
      
      private var var_554:IItemGridWindow;
      
      private var var_86:IBitmapWrapperWindow;
      
      private var var_1256:ITextWindow;
      
      private var var_1190:IScrollbarWindow;
      
      protected var var_1365:XML;
      
      private var var_1191:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_554 != null)
         {
            var_554.visible = false;
            var_554.destroyGridItems();
         }
         if(var_1190 != null)
         {
            var_1190.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1256.text = "${" + _loc3_.name + "}";
            var_1255.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1256.text = "${" + _loc2_.localizationId + "}";
            var_1255.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_356:
                  _loc4_ = var_1191.clone();
                  if(var_554 != null)
                  {
                     var_554.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_554,var_1190,var_1365);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_196:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_316,AvatarAction.const_583);
                              _loc13_.appendAction(AvatarAction.const_589,_loc6_.productClassId);
      ...
      {
         var_1256 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1255 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1444 = new Point(var_86.x,var_86.y);
         var_554 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1190 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_554 == null)
         {
         ...
         var_1191 = _loc2_.content as BitmapData;
