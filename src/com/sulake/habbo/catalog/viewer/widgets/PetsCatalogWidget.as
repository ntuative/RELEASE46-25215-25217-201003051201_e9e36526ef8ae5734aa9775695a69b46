package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_408 >= var_305.length)
         {
            return "";
         }
         var petColor:IPetColor = var_305[var_408] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_590[var_1527] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_408 = param1.index;
         if(var_408 < 0 || var_408 > var_305.length)
         {
            var_408 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_551.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         var_872 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_305 = [];
         var_590 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_872);
               if(_loc11_)
               {
                  var_590 = _loc11_.breeds;
         ...
         {
            _loc12_ = var_590[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_872,_loc12_.id),getRaceLocalizationKey(var_872,_loc12_.id)));
            _loc6_++;
         }
         var_551.add(var_872,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_1018,onApproveNameResult);
         _loc5_ = var_551.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_551.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_408 >= 0 && var_408 < var_305.length)
         {
            _loc7_ = var_305[var_408] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_590[var_1527] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_872,_loc3_.id,_loc2_,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_316,AvatarAction.const_522);
