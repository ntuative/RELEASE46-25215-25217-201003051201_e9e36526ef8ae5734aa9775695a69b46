   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_544,activateScrollbar);
            ...
            _scrollBar.addEventListener(WindowEvent.const_216,deActivateScrollbar);
         }
      }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_873 >= 0 && var_873 < page.offers.length)
            {
               _loc4_ = page.offers[var_873];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_356)
         {
            ++var_1528;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1528);
         }
      }
      
      override public function init() : void
      {
         var_927 = _window.findChildByName("itemGrid") as IItemGridWindow;
