package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1072 != null)
         {
            var_1072.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1073 != null)
         {
            var_1073.removeEventListener(WindowKeyboardEvent.const_143,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1072 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1072 != null)
         {
            var_1072.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1073 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1073 != null)
         {
            var_1073.addEventListener(WindowKeyboardEvent.const_143,windowKeyEventProcessor);
         }
      }
