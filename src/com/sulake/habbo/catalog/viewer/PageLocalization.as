package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_184:Dictionary = new Dictionary();
      
      private static const const_769:Object = {"frontpage3":[7,8]};
      
      private static const const_1102:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_770:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      private static const const_1103:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      
      {
         const_184["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_184["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_184["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_184["collectibles"] = ["ctlg_collectibles_link"];
         const_184["club1"] = ["ctlg_text_5"];
      }
      ...
      {
         if(param1 < var_585.length)
         {
            return var_585[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_585.length)
         {
            _loc2_ = String(var_585[param1]).replace("#","0x");
