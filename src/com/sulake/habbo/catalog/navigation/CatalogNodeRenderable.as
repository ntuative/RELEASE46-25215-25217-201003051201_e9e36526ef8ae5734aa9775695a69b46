package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1053:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1429:XML;
      
      private static var var_1428:XML;
      ...
      private var var_1430:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1430 == 4294967295)
            {
               var_1430 = _loc1_.color;
            }
            _loc1_.color = const_1053;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1247;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1429) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_48 = navigator.catalog.windowManager.buildFromXML(var_1428) as IItemListWindow;
         if(var_48 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1261;
            }
         }
      }
