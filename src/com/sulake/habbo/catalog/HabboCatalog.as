package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_308:CatalogViewer;
      
      private var var_2166:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_413:ICatalogNavigator;
      ...
      private var var_2167:GiftWrappingConfiguration;
      ...
      private var var_1065:ClubGiftController;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_157.credits = _loc3_.balance;
         updatePurse();
         if(!var_2168 && var_506 != null)
         {
            var_506.playSound(HabboSoundTypesEnum.const_864);
         }
         var_2168 = false;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_90:
               var_1317 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2167 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_184 != null && _loc2_)
         {
            var_184.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_211,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1065.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_413 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_157.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_157.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1065 == null)
         {
            var_1065 = new ClubGiftController(this);
         }
      }
      ...
      {
         var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_413.buildCatalogIndex(_loc2_);
         if(var_1066 != "")
         {
            var_413.openPage(var_1066);
            var_1066 = "";
         }
         else
         {
            var_413.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_308 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_308.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_157.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_157.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_157.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_157.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_308.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_157.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2166 && var_506 != null)
         {
            var_506.playSound(HabboSoundTypesEnum.const_994);
         }
         var_2166 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_308.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_308.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_308 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_308.habboCatalog = this;
      }
