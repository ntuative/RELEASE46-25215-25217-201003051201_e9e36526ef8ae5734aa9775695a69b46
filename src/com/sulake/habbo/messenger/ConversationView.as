package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_785:int = 100;
       
      
      private var var_2193:IScrollbarWindow;
      
      private var var_124:HabboMessenger;
      
      private var var_1569:IContainerButtonWindow;
      
      private var var_512:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         ...
         var_2193 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_518 || param3.type == Message.const_528 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_512.messages.length - const_785);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_512.messages.length)
         {
            refreshEntry(true,_loc1_,var_512.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_512 == null || _loc1_.id != var_512.id)
         {
            var_512 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_785 + const_1129)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_124.send(new FollowFriendMessageComposer(var_512.id));
      }
