package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         var_802 = IWindowContainer(param2.findChildByName("conversationstab"));
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_170 ? var_124.conversations.findConversation(param2.id) : var_124.conversations.openConversations[_loc3_ + var_124.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         var _loc3_:IWindowContainer = var_802.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
         refreshArrow(_loc3_,param1,param2);
         refreshTabBg(_loc3_,param1,!!param2 ? "tab_bg_next" : "tab_bg_unsel");
         var _loc4_:int = 0 % var_1189;
         _loc3_.width = var_1189 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         _loc3_.x = param1 * var_1189;
         _loc3_.width = var_1189;
         return false;
      }
   }
}
