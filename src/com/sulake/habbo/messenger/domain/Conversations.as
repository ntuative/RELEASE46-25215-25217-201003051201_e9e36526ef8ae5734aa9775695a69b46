package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private var var_393:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_649,0,var_393.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_393.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_393.getTabCount());
      ...
      {
         return var_393.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(_startIndex + var_393.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_393.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_582,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_393.addMsgToView(_loc3_,param1);
