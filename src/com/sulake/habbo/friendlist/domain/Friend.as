package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1445:int = "F".charCodeAt(0);
      
      public static const const_1477:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_951 = param1.gender;
         var_667 = param1.online;
         var_1195 = param1.followingAllowed && param1.online;
         var_604 = param1.figure;
         var_1194 = param1.motto;
         var_1193 = param1.lastAccess;
         var_1197 = param1.categoryId;
         var_1196 = param1.realName;
