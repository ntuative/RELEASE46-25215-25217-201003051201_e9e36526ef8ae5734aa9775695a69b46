package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1410:String = "no_reqs_info";
       
      
      private var var_1482:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1481:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_335 && _loc4_.state != FriendRequest.const_306)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_335;
      ...
      {
         var_1482 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1481 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1481.procedure = onDismissAllButtonClick;
         var_1482.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_335 && _loc4_.state != FriendRequest.const_306)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_270,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_335)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1482,_loc1_);
         setEnabled(var_1481,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_335;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_270,param1));
         }
      }
   }
}
