package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1432:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1176));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1432[var_1176]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(_friendList.view.mainWindow,var_257.width,var_257.height);
         var_257.x = _loc2_.x;
         var_257.y = _loc2_.y;
         var_1432[var_1176] = var_257;
      }
   }
}
