package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private function prepare() : void
      {
         ...
         var_802 = IWindowContainer(var_12.content.findChildByName("main_content"));
         var_253 = IWindowContainer(var_12.content.findChildByName("footer"));
         var_1304.prepare(var_802);
         var_12.procedure = onWindow;
         var_12.content.setParamFlag(HabboWindowParam.const_847,false);
         var_12.content.setParamFlag(HabboWindowParam.const_1345,true);
         var_12.header.setParamFlag(HabboWindowParam.const_660,false);
         var_12.header.setParamFlag(HabboWindowParam.const_815,true);
         var_12.content.setParamFlag(HabboWindowParam.const_660,false);
         var_12.content.setParamFlag(HabboWindowParam.const_815,true);
         var_12.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1305 = ITextWindow(var_12.findChildByName("info_text"));
         var_1305.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_12.scaler.setParamFlag(HabboWindowParam.const_872,this._friendList.tabs.findSelectedTab() != null);
         var_12.scaler.setParamFlag(HabboWindowParam.const_660,false);
         var_12.scaler.setParamFlag(HabboWindowParam.const_847,false);
         var_12.scaler.x = 0 - var_12.scaler.width;
         var_12.scaler.y = 0 - var_12.scaler.height;
         var_1533 = var_12.height;
         var_1534 = var_12.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc4_:int = var_1534 == -1 ? 0 : int(0 - var_1534);
