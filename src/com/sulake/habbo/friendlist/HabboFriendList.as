package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1393:OpenedToWebPopup;
      
      private var var_763:IAvatarRenderManager;
      ...
      private var var_1394:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_762:FriendRequests;
      
      private var var_1643:int;
      
      var var_13:FriendCategories;
      
      private var var_1644:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_761:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1644 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_13 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1394 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_762.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_762.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_388.findTab(FriendListTab.const_83).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_762 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         ...
         var_13.addCategory(new FriendCategory(FriendCategory.const_358,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_439)
         {
            var_439 = new Timer(120000);
            var_439.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_439.start();
         }
         getBuddyRequests();
         registerListeners();
         var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_439.stop();
            var_439.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_439 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_763)
         {
            var_763.release(new IIDAvatarRenderManager());
            var_763 = null;
         }
         if(var_761)
         {
            var_761.release(new IIDHabboNotifications());
            var_761 = null;
         }
         if(var_184)
         {
      ...
      {
         var_184 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1394.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_762.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_184.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:FriendListTab = var_388.findTab(FriendListTab.const_83);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_763.createAvatarImage(param1,AvatarScaleType.const_98);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_762.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_388.findTab(FriendListTab.const_83);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_763 = param2 as IAvatarRenderManager;
      ...
      {
         var_761 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1393 == null)
         {
            var_1393 = new OpenedToWebPopup(this);
         }
         var_1393.show(x,y);
      }
