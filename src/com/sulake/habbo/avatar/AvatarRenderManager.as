package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1038:PaletteManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_300.getValue(AvatarType.const_89) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(var_97);
         }
         _loc2_ = var_300.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(var_97);
         }
      ...
      private function init() : void
      {
         ...
         var_1038 = new PaletteManager(_loc1_,_loc3_);
         ...
         var_300.add(AvatarType.const_89,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_300.add(AvatarType.PET,_loc5_);
      ...
      {
         var_733 = param1;
         if(var_733 == RenderMode.const_1222)
         {
            init();
         }
      }
      ...
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         ...
         var _loc6_:AvatarStructure = var_300.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_300.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_300.getValue(AvatarType.const_89) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_18,param1,param2,AvatarType.const_89);
      }
