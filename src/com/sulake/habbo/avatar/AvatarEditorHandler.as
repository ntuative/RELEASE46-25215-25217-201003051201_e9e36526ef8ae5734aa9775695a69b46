package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorHandler
   {
      ...
      public function saveCurrentSelection() : void
      {
         ...
         var _loc1_:String = var_11.figureData.getFigureString();
         var _loc2_:String = var_11.figureData.gender;
      ...
      private function onWardrobe(param1:WardrobeMessageEvent) : void
      {
         ...
         var_11.wardrobe.updateMyLooks(param1.state,param1.outfits);
      }
