package com.sulake.habbo.avatar.alias
{
   ...
   public class AssetAliasCollection
   {
      ...
      private var var_1405:AssetLibraryCollection;
      ...
      public function AssetAliasCollection(param1:AssetLibraryCollection, param2:Array)
      {
         ...
         super();
         var_1405 = param1;
         var_601 = new Dictionary();
         for each(_loc3_ in param2)
         {
            _loc4_ = var_1405.getAssetLibraryByName(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getAssetByName(param1:String) : IAsset
      {
         ...
         {
            _loc3_ = var_601[param1] as AssetAlias;
            param1 = _loc3_.link;
            _loc2_--;
         }
         return var_1405.getAssetByName(param1);
      }
      
      public function getAliasByName(param1:String) : AssetAlias
      {
         return var_601[param1] as AssetAlias;
      }
      
      public function hasAlias(param1:String) : Boolean
      {
         var _loc2_:AssetAlias = var_601[param1] as AssetAlias;
         return _loc2_ != null;
      }
