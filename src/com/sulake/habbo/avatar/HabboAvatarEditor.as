package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_544:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_632.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1130)
         {
            ...
            var_443["null"] = new FigureData(this);
            var_443["null"] = new FigureData(this);
            _loc1_ = var_443["null"];
            _loc2_ = var_443["null"];
            ...
            var_13 = new Map();
            var_13.add(AvatarEditorCategory.const_926,new GenericModel(this));
            var_13.add(AvatarEditorCategory.const_44,new HeadModel(this));
            var_13.add(AvatarEditorCategory.const_295,new TorsoModel(this));
            var_13.add(AvatarEditorCategory.const_1236,new LegsModel(this));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_544 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_952 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_952 >= _loc14_.clubLevel))
               {
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1313)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_952 >= _loc5_.clubLevel))
               {
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_632.getPalette(param1);
      }
      ...
      {
         var_632 = var_543.getFigureData(AvatarType.const_89);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_543 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_213 == null)
            {
               var_213 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_57,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_213.addChild(_view.window);
               var_213.center();
               var_213.visible = false;
            }
            var_213.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_926);
         if(var_544 != null)
         {
            var_544.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_952 = param3;
         var _loc4_:FigureData = var_443[param2];
         if(_loc4_ == null)
         {
            return;
         }
