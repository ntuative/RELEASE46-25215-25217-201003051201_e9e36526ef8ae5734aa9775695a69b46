package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1475,var_1478,var_1474,_alphaMultiplier);
         var_1014 = generatePaletteMapForGrayscale(var_1943,var_1944);
      }
      
      public function get reds() : Array
      {
         return var_1014.getValue("reds") as Array;
      }
      ...
      {
         return var_1014.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1014.getValue("greens") as Array;
      }
      ...
      {
         return var_1014.getValue("alphas") as Array;
      }
