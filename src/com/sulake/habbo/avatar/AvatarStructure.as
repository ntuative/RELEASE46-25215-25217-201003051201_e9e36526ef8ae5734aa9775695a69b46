package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1736:PartOffsetData;
      
      private var var_782:AvatarActionManager;
      ...
      private var var_1737:AvatarRenderManager;
      
      private var var_451:FigureData;
      ...
      private var var_1419:AvatarStructureDownloadSet;
      
      private var var_647:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_146 = param2;
         var_2285 = param3;
         var_451 = new FigureData();
         var_383 = new PartSetsData();
         _animationData = new AnimationData();
         var_1419 = new AvatarStructureDownloadSet();
         var_647 = new AnimationManager();
         var_646 = param4;
         var_1736 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_782.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_782.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_782.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_647.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1226[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_782.getDefaultActionType();
         var _loc7_:Array = var_383.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_647.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_451.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_451.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_383.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_383.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_646 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_89:
               var_1419.add(new AvatarStructureDownload(var_146,_loc5_,var_451));
               break;
            case AvatarType.PET:
         }
         var_1419.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_647.getAnimation(param1);
      }
      ...
      {
         var_782 = new AvatarActionManager(var_146,var_646);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_146.hasAsset("dance" + _loc1_))
         {
            ...
            var_647.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_451.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_451.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_782.sortActions(param1);
      }
   }
}
