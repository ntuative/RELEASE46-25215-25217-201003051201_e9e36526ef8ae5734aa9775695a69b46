package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_690:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_1031 = _loc8_.content as BitmapData;
         updateThumbData();
      }
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_691.width,var_691.height,true,0);
            _loc1_.bitmap.copyPixels(var_691,var_691.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_840.width,var_840.height,true,0);
            _loc4_ = var_840.clone();
            _loc4_.colorTransform(_loc4_.rect,var_690.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_692.width,var_692.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_692,var_692.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               {
                  _loc5_.bitmap.copyPixels(var_1031,var_1031.rect,new Point(0,0),null,null,true);
               }
            }
         }
      }
