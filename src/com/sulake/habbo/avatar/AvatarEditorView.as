package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1451:Boolean = true;
      
      private var var_339:Timer;
      
      private var var_1450:ITabSelectorWindow;
      ...
      private function createWindow() : void
      {
         ...
         var_1450 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_629 != null)
         {
            toggleCategoryView(var_629,true);
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_629 = param1;
         var_1450.setSelected(var_1450.getSelectableByName(param1));
         _window.invalidate();
      }
