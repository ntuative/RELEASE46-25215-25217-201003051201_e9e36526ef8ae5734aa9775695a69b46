package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public function toggleItemSelection(param1:String, param2:int) : void
      {
         ...
         var_11.figureData.savePartData(FigureData.const_56,_loc4_.id,_loc3_.getCurrentColorIds(),true);
      ...
      private function init() : void
      {
         ...
         var_13 = new Map();
         var_13["null"] = var_11.generateDataContent(this,FigureData.const_56);
      ...
      public function toggleColorSelection(param1:String, param2:int) : void
      {
         ...
         var_11.figureData.savePartSetColourId(FigureData.const_56,_loc3_.getCurrentColorIds(),true);
         updateView();
      }
      ...
      private function updateCategoryData(param1:String) : void
      {
         ...
         var _loc2_:int = var_11.figureData.getPartSetId(FigureData.const_56);
         var _loc3_:Array = var_11.figureData.getColourIds(FigureData.const_56);
