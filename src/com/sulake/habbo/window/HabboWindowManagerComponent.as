package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1131:uint = 1;
      ...
      private var var_1347:ProfilerAgentTask;
      
      private var var_1344:IEventDispatcher;
      
      private var var_2373:uint = 0;
      
      private var var_1345:ProfilerAgentTask;
      
      private var var_1346:ProfilerOutput;
      
      private var var_737:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1344 = Component(param1).events;
         var_428 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_737 = new WindowRenderer(_loc4_);
         var_239 = new Array(const_347);
         var _loc6_:int = 0;
         while(_loc6_ < const_347)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_737,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_239[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_213 = var_239[const_1131];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_213.getMouseCursor().defineCustomCursorType(MouseCursorType.const_331,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_213.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1144,_loc7_);
      }
      ...
      {
         return var_239[param1].getDesktopWindow().getChildAt(var_213.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1346 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1346 = new ProfilerOutput(_loc3_,this,var_737);
               var_1347 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1347);
               var_1345 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1345);
               var_1080 = true;
            }
         }
      }
      ...
      {
         return var_213.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1344.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_347 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1344.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         var_1344.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      {
         return var_213.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1146,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1213,param2.name + ": " + param2.toString());
            }
