package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_519:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_517 != null)
         {
            ...
            {
               _loc2_ = var_517.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_517.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_739.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_300:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_98);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_98);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_517.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_739.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_547,RoomWidgetChatSelectAvatarMessage.const_501];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_547:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_137,_container.roomSession,0,"Version 25215-25217-201003051129");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_501:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_519 == null)
            {
               ...
               var_518.y = 0;
               var_518.z = 0;
               var_519 = _loc4_.getScreenPoint(var_518);
            ...
            var_518.y = 0;
            var_518.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_518);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_519.x || _loc8_.y != var_519.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_519,_loc5_));
