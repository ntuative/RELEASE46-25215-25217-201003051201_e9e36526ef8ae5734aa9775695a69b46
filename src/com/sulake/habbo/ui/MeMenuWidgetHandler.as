   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_992,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_682,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_443,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_682,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_890,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_826,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_443,onHelpTutorialEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_594);
         _loc1_.push(RoomWidgetDanceMessage.const_667);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_710);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_718);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_713);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_536);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_700);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_676);
         _loc1_.push(RoomWidgetStopEffectMessage.const_712);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1333);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_893);
         _loc1_.push(RoomWidgetToolbarMessage.const_643);
         _loc1_.push(RoomWidgetToolbarMessage.const_555);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_531);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1180);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_845);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_618);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_533);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_506);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_717);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1255);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_628);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_525);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_674);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_565));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_533:
               ...
               break;
            case RoomWidgetWaveMessage.const_594:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_667:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_710:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_718:
               if(var_8 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_676:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_538)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_265,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_700:
               ...
               if(var_8 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_993:
                        _catalog.openCatalogPage(CatalogPageName.const_1208,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_938:
                        var_8.toggleInventoryPage(InventoryCategory.const_241);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1377:
                        var_8.toggleInventoryPage(InventoryCategory.const_69);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1283:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_712:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_805:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1341:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_893:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_618:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_643:
               ...
               break;
            case RoomWidgetToolbarMessage.const_555:
               ...
               if(var_184 && false)
               {
                  var_184.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_389,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_531:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == 0)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_387,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_917));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_387,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1193));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_543));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_506:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_717:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_314,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_628:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_314,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_525:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_314,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_674:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_616));
               }
               break;
            default:
