   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_132,onUserTags);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_132,onUserTags);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_278);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_918);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_877);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_300)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_464)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_953)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_192)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_187)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_508);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1375;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1015;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_855;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1304);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_563.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_51);
            var_563.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_508);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_311);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_588);
         _loc1_.push(RoomWidgetFurniActionMessage.const_498);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_695);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_530);
         _loc1_.push(RoomWidgetUserActionMessage.const_384);
         _loc1_.push(RoomWidgetUserActionMessage.const_733);
         _loc1_.push(RoomWidgetUserActionMessage.const_693);
         _loc1_.push(RoomWidgetUserActionMessage.const_1320);
         _loc1_.push(RoomWidgetPetCommandMessage.const_550);
         _loc1_.push(RoomWidgetPetCommandMessage.const_520);
      ...
      public function dispose() : void
      {
         ...
         if(var_563 != null)
         {
            _loc1_ = var_563.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_563.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_384)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_311:
            ...
            case RoomWidgetUserActionMessage.const_672:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_882,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_693:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_588:
            ...
            case RoomWidgetFurniActionMessage.const_269:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_498:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_530:
               ...
               break;
            case RoomWidgetUserActionMessage.const_384:
