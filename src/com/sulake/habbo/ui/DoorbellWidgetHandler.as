package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_96:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_573,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_614];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_614:
      ...
      {
         return [RoomSessionDoorbellEvent.const_96,RoomSessionDoorbellEvent.const_125,RoomSessionDoorbellEvent.const_52];
      }
