package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_731,RoomWidgetEcotronBoxOpenMessage.const_709,RoomWidgetEcotronBoxOpenedMessage.const_1165];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_731:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_709:
