package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_788:IRoomWidgetFactory;
      ...
      private var var_543:IAvatarRenderManager;
      ...
      private var var_789:IHabboHelp;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_692);
         _loc3_.init();
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_100:
               if(param1.session != null)
               {
                  ...
                  var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.ZOOM));
                  var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.MEMENU));
                  var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            _adManager.events.addEventListener(AdEvent.const_430,adEventHandler);
            _adManager.events.addEventListener(AdEvent.const_364,adEventHandler);
            _adManager.events.addEventListener(AdEvent.const_465,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_788 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_788 != null)
         {
            var_788.release(new IIDHabboRoomWidget());
            var_788 = null;
         }
         if(var_8 != null)
         {
         ...
         if(var_543 != null)
         {
            var_543.release(new IIDAvatarRenderManager());
            var_543 = null;
         }
         if(_catalog != null)
         {
         ...
         if(var_789 != null)
         {
            var_789.release(new IIDHabboHelp());
            var_789 = null;
         }
         ...
         if(var_651 != null)
         {
            var_651.release(new IIDHabboModeration());
            var_651 = null;
         }
         if(_navigator != null)
         {
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_651 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_651);
      }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_551:
               ...
               if(var_1425 != RoomDesktop.const_612)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_251,var_1425);
               }
               if(_adManager != null)
               {
               ...
               break;
            case RoomEngineEvent.const_500:
               disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_728:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_736:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_706:
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomEngineEvent.const_551,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_500,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.DIMMER_STATE,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_728,roomEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_254,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_604,roomObjectEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_543 = param2 as IAvatarRenderManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_17)
         {
            var_17.events.addEventListener(RoomSessionEvent.const_334,roomSessionStateEventHandler);
            var_17.events.addEventListener(RoomSessionEvent.const_90,roomSessionStateEventHandler);
            ...
            var_17.events.addEventListener(RoomSessionUserBadgesEvent.const_126,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionDoorbellEvent.const_96,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionDoorbellEvent.const_125,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionDoorbellEvent.const_52,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionPresentEvent.const_263,roomSessionEventHandler);
            ...
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_658,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_905,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_859,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_189,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_220,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_185,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_208,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_224,roomSessionDialogEventHandler);
            ...
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_593,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_736,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_173,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_706,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_605,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionQueueEvent.const_357,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionVoteEvent.const_122,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionVoteEvent.const_114,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionPollEvent.const_111,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionPollEvent.const_58,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionPollEvent.const_120,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionDimmerPresetsEvent.const_407,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionFriendRequestEvent.const_118,roomSessionEventHandler);
         }
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1169 = param2 as IHabboAvatarEditor;
      }
   }
}
