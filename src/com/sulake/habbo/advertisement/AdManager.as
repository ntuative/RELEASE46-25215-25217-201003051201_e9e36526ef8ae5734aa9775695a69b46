package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_750:BitmapData = null;
      ...
      private var var_751:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_465,0,0,_loc4_,var_1383,var_751,var_750));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1616 = int(_config.getKey("interstitial.interval","30000"));
         var_1614 = int(_config.getKey("interstitial.show.time","5000"));
         var_1382 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1110 = _loc2_.imageUrl;
         var_1383 = _loc2_.clickUrl;
         if(var_1110 != "" && var_1383 != "")
         {
            _loc3_ = var_1110;
            ...
            _loc4_ = new URLRequest(var_1110);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1109 = _loc2_.imageUrl;
         var_1615 = _loc2_.clickUrl;
         var_623 = getTimer();
         if(var_1109 != "")
         {
            _loc3_ = var_1109;
            ...
            var_211.start();
            _loc4_ = new URLRequest(var_1109);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_364,0,0,param1.bitmapData,var_1615));
            var_623 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_750 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1382 > 0 && var_1381 >= var_1382)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_623;
         if(_loc1_ > var_1616)
         {
            ++var_1381;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_430));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_751 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
