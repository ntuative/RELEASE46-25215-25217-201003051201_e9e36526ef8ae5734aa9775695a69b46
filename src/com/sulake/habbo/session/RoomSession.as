package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1043:UserDataManager;
      ...
      {
         if(var_33 == RoomSessionEvent.const_334 && _connection != null)
         {
            var_33 = RoomSessionEvent.const_90;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1043 as IUserDataManager;
      }
