package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1484:UserTagManager;
      ...
      private var var_1485:GroupDetailsView;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_683 = [];
         var_1484 = new UserTagManager(events);
      ...
      {
         var_1023.removeEventListener(ProductDataParser.READY,onProductsReady);
         var_1023 = null;
         var_575 = new Map();
         var_442 = new Map();
         var_400 = new Map();
         ...
         var_1022 = new FurnitureDataParser(_loc2_,var_575,var_442,var_400,_localization);
         var_1022.addEventListener(FurnitureDataParser.READY,onFurnitureReady);
      }
      
      public function getUserTags(param1:int) : Array
      {
         return var_1484.getTags(param1);
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var _loc3_:String = var_175.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_1023 = new ProductDataParser(_loc2_,var_817);
         var_1023.addEventListener(ProductDataParser.READY,onProductsReady);
      }
      ...
      {
         return var_1243.getBadgeImage(param1,BadgeImageManager.const_870);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _id = _loc3_.id;
         _name = _loc3_.name;
         var_1814 = _loc3_.respectTotal;
         var_834 = _loc3_.respectLeft;
         var_493 = _loc3_.petRespectLeft;
         var_604 = _loc3_.figure;
         var_951 = _loc3_.sex;
         var_1196 = _loc3_.realName;
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_1983 = _loc2_.isOpen;
         var_1984 = _loc2_.onShutDown;
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || var_834 < 1 || _loc2_ == null)
         {
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(var_1485 == null)
         {
            var_1485 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = var_1024.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            var_1485.showGroupDetails(param1);
         }
      }
      
      private function onFurnitureReady(param1:Event = null) : void
      {
         var_1022.removeEventListener(FurnitureDataParser.READY,onFurnitureReady);
         var_1022 = null;
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_493 < 1 || _loc2_ == null)
         {
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            var_604 = _loc2_.figure;
            var_951 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_604));
         }
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1484.communication = _communication;
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return var_575.getValue(param1.toString());
      }
      ...
      public function getWallItemData(param1:int) : IFurnitureData
      {
         ...
         return var_442.getValue(param1.toString());
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1243 = new BadgeImageManager(_loc1_,events,var_175,_localization);
      }
