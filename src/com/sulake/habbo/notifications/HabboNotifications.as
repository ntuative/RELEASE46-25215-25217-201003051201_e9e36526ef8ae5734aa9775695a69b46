package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1097:String = "badges";
      
      private static const const_1100:String = "pixelbalance";
      
      private static const const_1096:String = "credits";
      
      private static const const_1098:String = "inventory";
      
      private static const const_1095:String = "friendlist";
      
      private static const UILINK_SELECTFURNI:String = "selectfurni";
      
      private static const const_1099:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_583:ParkBusDialogManager;
      
      private var var_584:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_403:HabboNotificationViewManager;
      ...
      private var var_706:ClubGiftNotification;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1362);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_706 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_816)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1259);
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_193.method_12(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1164);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2066)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_711);
            var_2066 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_584)
         {
            var_584.release(new IIDHabboToolbar());
            var_584 = null;
         }
         if(_windowManager)
         {
      ...
      {
         if(param1 != null && this.var_403 != null)
         {
            var_403.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_711,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_543.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_873,_loc5_);
         }
      }
      ...
      {
         if(var_403.isSpaceAvailable() && false)
         {
            var_403.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_583 == null)
         {
            var_583 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_583 != null)
         {
            var_583.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1046.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_543.createPetImage(_loc2_.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_711,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_543.createAvatarImage(param2,AvatarScaleType.const_51);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_202);
         }
      }
      ...
      {
         var_584 = IHabboToolbar(param2);
         var_584.events.addEventListener(HabboToolbarEvent.const_79,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_350.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_939);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_939);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_79)
         {
            ...
            var_403 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_854["styles"],var_854["view"],var_584);
            ...
            registerUpdateReceiver(var_403,1);
            registerUpdateReceiver(this,2);
            var_350.events.addEventListener(BadgeImageReadyEvent.const_109,onBadgeImage);
            var_584.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
