package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_103,WindowParam.const_149);
         var _loc2_:* = !testParamFlag(WindowParam.const_123,WindowParam.const_135);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_155)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_15 & 0);
               if(_loc5_ == WindowParam.const_248)
               {
      ...
      {
         var_745 = param1;
         var_616 = !!var_745 ? uint(var_616 | var_1373) : uint(var_616 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2241 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_867:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1271:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1356:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_999:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_729:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_392:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_631:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_217:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_418:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_247:
               _loc2_ = "null";
         }
         if(_loc2_ == WindowEvent.const_154)
         {
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_81 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_427,this,null));
         }
      }
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_964;
         update(this,_loc1_);
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_842;
         update(this,_loc1_);
         return true;
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_698,var_5);
            var_16.visible = var_343;
         }
         return var_16;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_793;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_406 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_5,WindowRedrawFlag.const_973);
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_616 = !!var_745 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_5,WindowRedrawFlag.const_70);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_606))
         {
            ...
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  if(testParamFlag(WindowParam.const_299))
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_211))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_211))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_188:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_418,this,null));
                     if(testParamFlag(WindowParam.const_155,WindowParam.const_149))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_157,WindowParam.const_135))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                     {
                        ...
                        var_15 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_247,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_362:
                  _context.invalidate(this,var_5.union(var_54),WindowRedrawFlag.const_456);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_790,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_264,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_327:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_631,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_217,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_481:
                  _context.invalidate(this,var_5,WindowRedrawFlag.const_912);
                  break;
               case WindowNotifyEvent.const_427:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_392:
                  if(!(var_15 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_456);
                     }
                  }
                  else if(var_15 & 0)
                  {
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_607,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_591;
         update(this,_loc1_);
         return true;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_439)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_15 & 0);
            if(_loc7_ == WindowParam.const_388)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_850,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_602,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_362,this,null));
            }
            if(_loc6_)
            {
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1270,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_162 && var_746 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1578,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1578,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_60,false);
         _loc1_.type = WindowNotifyEvent.const_1201;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               ...
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_462,this,var_6));
            }
            else
            {
               var_313.x = 0;
               ...
               var_313.width = 0;
               var_313.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_949,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_15,_context,var_5,null,var_617,properties,var_615.concat(),_id) as WindowController;
         ...
         _loc2_.var_616 = var_616;
         _loc2_.var_1373 = var_1373;
         _loc2_.var_1102 = var_1102;
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_999,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_729;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_446;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_962,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         if(var_33 == WindowState.const_351)
         {
            return true;
         }
         var_33 = WindowState.const_351;
