package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1508:String = "_INCLUDE";
      
      public static const const_928:String = "_EXCLUDE";
      
      public static const const_1530:String = "_TEMP";
      
      private static const const_1117:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1118:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_928:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1101,var_1100);
         var_928 = new Dictionary();
         var_1372 = new Dictionary();
         ParamCodeTable.fillTables(var_928,var_1372);
         var_1371 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1118,"");
         return param1.replace(const_1117,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_928)
            {
               delete var_928[_loc1_];
            }
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_155)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_928) == -1)
                  {
