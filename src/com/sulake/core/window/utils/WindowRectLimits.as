package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         return var_426 == int.MIN_VALUE && var_424 == int.MAX_VALUE && var_425 == int.MIN_VALUE && var_427 == int.MAX_VALUE;
      }
      ...
      {
         var_427 = param1;
         if(var_427 < int.MAX_VALUE && true && _target.height > var_427)
         {
      ...
      {
         var_426 = param1;
         if(var_426 > int.MIN_VALUE && true && _target.width < var_426)
         {
      ...
      {
         var_425 = param1;
         if(var_425 > int.MIN_VALUE && true && _target.height < var_425)
         {
