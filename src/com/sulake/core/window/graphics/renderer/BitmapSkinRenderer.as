         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_414)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_231)
                  {
                     _loc14_ = true;
                     _loc13_.right += _loc16_;
                     if(_loc13_.width < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_414)
                  {
                     _loc15_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_231)
                  {
                     _loc15_ = true;
                     _loc13_.bottom += _loc17_;
                     if(_loc13_.height < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_231 || _loc11_.scaleH == SkinLayoutEntity.const_231)
                  {
                  ...
                  {
                     var_634.a = _loc13_.width / _loc19_.width;
                     var_634.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_634);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_634,null);
