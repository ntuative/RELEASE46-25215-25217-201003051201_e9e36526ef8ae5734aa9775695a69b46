package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_315:Dictionary;
      ...
      {
         var _loc3_:ISkinTemplate = var_315[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         for(_loc1_ in var_315)
         {
            ISkinTemplate(var_315[_loc1_]).dispose();
            delete var_315[_loc1_];
         }
         var_315 = null;
         var_316 = null;
      }
