package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1068:uint = 8;
      ...
      private var var_1220:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1459,var_1891);
         var_1220 = new Dictionary();
         var_1892 = new Dictionary();
         StateCodeTable.fillTables(var_1220,var_1892);
         var_485 = new Dictionary();
         var_485["skin"] = BitmapSkinRenderer;
         var_485["bitmap"] = BitmapDataRenderer;
         var_485["fill"] = FillSkinRenderer;
         var_485["text"] = TextSkinRenderer;
         var_485["shape"] = ShapeSkinRenderer;
         var_485["unknown"] = SkinRenderer;
         var_485["null"] = NullSkinRenderer;
         if(var_367 == null)
         {
            var_367 = new Array();
            var_367.push(WindowState.const_60);
            var_367.push(WindowState.const_64);
            var_367.push(WindowState.const_92);
            var_367.push(WindowState.const_46);
            var_367.push(WindowState.const_73);
            var_367.push(WindowState.const_72);
            var_367.push(WindowState.const_93);
            var_367.push(WindowState.const_84);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1220)
         {
            _loc3_.push(var_1220[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1459[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_565[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_565[param1] = new Array(SkinContainer.const_1068);
         }
         var_565[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_565[_loc1_]).dispose();
