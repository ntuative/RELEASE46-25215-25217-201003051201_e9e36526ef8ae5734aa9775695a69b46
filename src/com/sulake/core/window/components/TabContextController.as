package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_920:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1585 == null)
         {
            var_1585 = findChildByTag(TabContextController.const_1030) as IWindowContainer;
         }
         return var_1585;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_920 == null)
         {
            var_920 = findChildByTag(TabContextController.const_1031) as ITabSelectorWindow;
            if(var_920 != null)
            {
               var_920.procedure = selectorEventProc;
            }
         }
         return var_920;
      }
      ...
      {
         return !!var_887 ? selector.iterator : null;
      }
