package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_763:String = "margin_top";
      
      private static const const_1074:String = "_HEADER";
      
      private static const const_764:String = "margin_right";
      
      private static const const_1073:String = "_SCALER";
      
      private static const const_1075:String = "_TITLE";
      
      private static const const_1076:String = "_CONTENT";
      
      private static const const_762:String = "margin_left";
      
      private static const const_765:String = "margin_bottom";
      ...
      private var var_1235:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_762,_loc3_.left,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_763,_loc3_.top,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_764,0 - _loc3_.right,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_765,0 - _loc3_.bottom,PropertyStruct.const_59,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_232);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_205);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_223);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_223,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_223,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1235 == null)
         {
            var_1235 = findChildByTag(const_1074) as IHeaderWindow;
            if(!var_1235)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1075) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1073) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_267,false);
         }
      ...
      {
         return content != null && var_1362 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1076) as IWindowContainer;
            if(!var_20)
            {
