package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_875:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_355)
         {
            ...
            if(var_355)
            {
               var_355.addEventListener(WindowEvent.const_262,scrollBarEventProc);
               var_355.addEventListener(WindowEvent.const_216,scrollBarEventProc);
            }
         }
         return var_355;
      }
      ...
      override public function dispose() : void
      {
         if(var_355)
         {
            var_355.removeEventListener(WindowEvent.const_262,scrollBarEventProc);
            var_355.removeEventListener(WindowEvent.const_216,scrollBarEventProc);
            var_355 = null;
         }
         if(var_875)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_216)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_875)
         {
            var_875 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_875;
      }
