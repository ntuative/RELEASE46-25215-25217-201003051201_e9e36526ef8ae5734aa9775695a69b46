package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_611 * maxScrollH,var_361 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_741)
         {
            context.removeLocalizationListener(var_318,this);
         }
         if(var_67 != null)
         {
            var_67.dispose();
      ...
      {
         var_611 = param1;
         _field.scrollH = var_611 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_318 = param1;
         if(var_318.charAt(0) == "$" && var_318.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_318.slice(2,var_318.indexOf("}")),this);
            var_741 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_952,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_463,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_463,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_539,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_539,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_539,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
