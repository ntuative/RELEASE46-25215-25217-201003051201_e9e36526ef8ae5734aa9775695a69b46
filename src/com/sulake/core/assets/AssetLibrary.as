package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_913:String = "AssetLibraryReady";
      
      public static const const_1159:String = "AssetLibraryUnloaded";
      
      public static const const_475:String = "AssetLibraryLoaded";
      
      public static const const_1197:String = "AssetLibraryLoadError";
       
      
      private var var_516:XML;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_422)
         {
            _loc4_ = AssetTypeDeclaration(var_422[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_736)
         {
            delete var_736[_loc1_];
         }
         if(var_14 != null)
         {
            var_14.dispose();
         ...
         var_312 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1159));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_516 = _loc2_.manifest.copy();
         var_358 = _loc2_.resource;
         if(var_515)
         {
            AssetLibrary.fetchLibraryContents(this,var_516,var_358);
         }
         var_312 = true;
         dispatchEvent(new Event(AssetLibrary.const_475));
         dispatchEvent(new Event(AssetLibrary.const_913));
         if(var_515)
         {
            var_14.dispose();
            var_14 = null;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_422.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_422[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1197));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_422)
         {
            _loc3_ = AssetTypeDeclaration(var_422[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_736[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_516.child("library");
         if(_loc2_ == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_422[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
