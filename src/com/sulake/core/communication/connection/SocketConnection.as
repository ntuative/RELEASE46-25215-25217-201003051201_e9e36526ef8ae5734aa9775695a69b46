package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1219:int = 10000;
      ...
      private var var_321:IConnectionStateListener;
      
      private var var_532:IProtocol;
      
      private var var_752:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_752 = new MessageClassManager();
         var_76 = new Socket();
         var_322 = new Timer(const_1219,1);
      ...
      {
         var_322.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_624));
      ...
      {
         var_322.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_624));
      ...
      {
         var_322.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_624));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_752.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_532.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_321)
         {
            var_321.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_625 != null)
         {
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_321)
         {
            var_321.connectionInit(param1,param2);
         }
      ...
      {
         var_752.registerMessages(param1);
      }
      ...
      {
         var_322.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_624));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_532.getMessages(var_323,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_321)
            {
               var_321.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_752.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
      ...
      {
         var_322.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_624));
         switch(param1.type)
         {
      ...
      {
         var_322.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_624));
         dispatchEvent(param1);
      }
