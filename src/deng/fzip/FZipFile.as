package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      public static const const_1535:int = 10;
      
      public static const const_1383:int = 6;
      
      private static var var_973:Boolean = describeType(ByteArray).factory.method.(@name == "uncompress").hasComplexContent();
      ...
      private var var_1408:String = "2.0";
      ...
      {
         var _loc2_:* = 0;
         if(var_641 === const_680 && !var_1410)
         {
            if(var_973)
            {
               param1.readBytes(var_20,0,var_166);
            }
            else
            {
               if(!var_449)
               ...
               _loc2_ = uint(~var_1721 << 6 & 192);
               _loc2_ += 31 - (30720 | _loc2_) % 31;
               var_20.writeByte(_loc2_);
               param1.readBytes(var_20,2,var_166);
         ...
         {
            if(var_641 != const_1274)
            {
               throw new Error("Compression method " + var_641 + " is not supported.");
            }
            param1.readBytes(var_20,0,var_166);
            var_165 = false;
         }
      ...
      public function setContentAsString(param1:String, param2:String = "utf-8") : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            var_642 = ChecksumUtil.CRC32(var_20);
            var_449 = false;
         }
         compress();
      }
      ...
      {
         var_643 = param1 != null ? param1 : new Date();
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         if(param3)
         {
            ...
            param1.writeShort(var_1143 << 8 | 20);
         }
         else
         {
         ...
         var _loc5_:Date = var_643 != null ? var_643 : new Date();
         var _loc6_:uint = uint(_loc5_.getSeconds()) | uint(_loc5_.getMinutes()) << 5 | uint(_loc5_.getHours()) << 11;
         var _loc7_:uint = uint(_loc5_.getDate()) | uint(_loc5_.getMonth() + 1) << 5 | uint(_loc5_.getFullYear() - 1980) << 9;
         param1.writeShort(_loc6_);
         param1.writeShort(_loc7_);
         param1.writeUnsignedInt(var_642);
         ...
         if(var_333 == "utf-8")
         {
            _loc8_.writeUTFBytes(var_382);
         }
         else
         {
            _loc8_.writeMultiByte(var_382,var_333);
         }
         ...
         if(param3 && false)
         {
            if(var_333 == "utf-8")
            {
               _loc8_.writeUTFBytes(var_1720);
            }
            else
            {
               _loc8_.writeMultiByte(var_1720,var_333);
            }
         }
      ...
      {
         if(param1.bytesAvailable >= var_974 + var_1144)
         {
            parseHeadExt(param1);
            parseFunc = parseFileContent;
            return true;
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         if(var_333 == "utf-8")
         {
            var_382 = param1.readUTFBytes(var_974);
         }
         else
         {
            var_382 = param1.readMultiByte(var_974,var_333);
         }
         var _loc2_:uint = var_1144;
         while(_loc2_ > 4)
         {
            ...
            if(_loc4_ > _loc2_)
            {
               throw new Error("Parse error in file " + var_382 + ": Extra field data size too big.");
            }
      ...
      protected function parseHead(param1:IDataInput) : void
      {
         ...
         var_1143 = _loc2_ >> 8;
         var_1408 = Math.floor((_loc2_ & 255) / 10) + "." + (_loc2_ & 255) % 10;
         var _loc3_:uint = param1.readUnsignedShort();
         var_641 = param1.readUnsignedShort();
         var_1410 = (_loc3_ & 1) !== 0;
         var_1409 = (_loc3_ & 8) !== 0;
         var_1722 = (_loc3_ & 32) !== 0;
         if((_loc3_ & 800) !== 0)
         {
            var_333 = "utf-8";
         }
         if(var_641 === const_1383)
         {
            var_2287 = (_loc3_ & 2) !== 0 ? 8192 : 4096;
            var_2288 = (_loc3_ & 4) !== 0 ? 3 : 2;
         }
         else if(var_641 === const_680)
         {
            var_1721 = (_loc3_ & 6) >> 1;
         }
         ...
         var_643 = new Date(_loc11_,_loc10_ - 1,_loc9_,_loc8_,_loc7_,_loc6_,0);
         var_642 = param1.readUnsignedInt();
         var_166 = param1.readUnsignedInt();
         var_546 = param1.readUnsignedInt();
         var_974 = param1.readUnsignedShort();
         var_1144 = param1.readUnsignedShort();
      }
      ...
      {
         return "[FZipFile]\n  name:" + var_382 + "\n  date:" + var_643 + "\n  sizeCompressed:" + var_166 + "\n  sizeUncompressed:" + var_546 + "\n  versionHost:" + var_1143 + "\n  versionNumber:" + var_1408 + "\n  compressionMethod:" + var_641 + "\n  encrypted:" + var_1410 + "\n  hasDataDescriptor:" + var_1409 + "\n  hasCompressedPatchedData:" + var_1722 + "\n  filenameEncoding:" + var_333 + "\n  crc32:" + var_642.toString(16) + "\n  adler32:" + var_776.toString(16);
      }
